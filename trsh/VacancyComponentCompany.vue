  ...
  <div class="vacancy_item">
    <div :class="vacancies_item_block">
      <div :class="vacancies_item_header">
        <div :class="vacancies_item_logo"></div>
        <div :class="vacancies_item_vacanciesInfo">
          <div :class="vacancies_item_vacanciesInfo_header">
            <div :class="vacancies_item_name">IT Professionals Work</div>
            <div :class="vacancies_item_tag">@ipw</div>
          </div>
          <div :class="vacancies_item_levelDirection">Senior Golang Developer</div>
          <div :class="vacancies_item_location">Ufa / Full Day</div>
          <!-- <div class="vacancies_item_levelDirection"></div> ?? >> email -->
        </div>
      </div>
      <div :class="vacancies_item_description">
      ...
      <div :class="vacancies_item_skills">
...
<style module>
@import 'assets/css/vacancyCompany.css';
</style>